...
class QuadrangleAttention(nn.Module):
    def __init__(self, input_resolution, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., window_size=7, rpe='v2', coords_lambda=20):
        super().__init__()
        self.num_heads = num_heads
        head_dim = dim // num_heads
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.pos = get_conv2d(dim, dim, 7, 1, 3, 1, groups=dim, bias=True)
